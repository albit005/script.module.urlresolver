...
class FilenukeResolver(Plugin, UrlResolver, PluginSettings):
    ...
    def __init__(self):
        ...
        self.priority = int(p)
        self.net = Net()
        # http://allmyvideos.net/6ngufgpm9zqz
        # http://allmyvideos.net/embed-6ngufgpm9zqz.html
        # http://allmyvideos.net/embed-6ngufgpm9zqz-900x479.html
        self.pattern = 'http://((?:www.)?allmyvideos.net)/(?:embed.)?([0-9a-zA-Z]+)'
